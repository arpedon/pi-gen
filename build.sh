...
export WPA_COUNTRY=${WPA_COUNTRY:-GR}
...
export TIMEZONE_DEFAULT="${TIMEZONE_DEFAULT:-Europe/Athens}"

export GIT_HASH=${GIT_HASH:-"$(git rev-parse HEAD)"}

export PUBKEY_SSH_FIRST_USER="${PUBKEY_SSH_FIRST_USER:-ssh-rsa  tsangiotis@computer.com}"
...
echo "Tailscale Key is: ${TAILSCALE_AUTH_KEY}"
